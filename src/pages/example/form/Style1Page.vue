    ...
    <form class="space-y-8 divide-y divide-gray-200">
      <div class="space-y-8 divide-y divide-gray-200 sm:space-y-5">
        <div class="space-y-6 sm:space-y-5">
          <div>
            <h1 class="text-xl leading-6">Profile</h1>
            <p class="mt-3">This information will be displayed publicly so be careful what you share.</p>
          </div>

          <div class="space-y-6 sm:space-y-5">
            <div class=" sm:grid sm:grid-cols-3 md:items-start md:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
              <div>
                <label for="username" class="flex">Username</label>
                <p>this is the username description if the length of the text </p>
              </div>
            ...
            <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
              <label for="about" class="flex text-sm text-gray-700 sm:mt-px sm:pt-2">About</label>
              <div class="mt-1 sm:col-span-2 sm:mt-0">
            ...
            <div class="sm:grid sm:grid-cols-3 sm:items-center sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
              <label for="photo" class="flex text-sm text-gray-700">Photo</label>
              <div class="mt-1 sm:col-span-2 sm:mt-0">
            ...
            <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:border-t sm:border-gray-200 sm:pt-5">
              <label for="cover-photo" class="flex text-sm text-gray-700 sm:mt-px sm:pt-2">Cover photo</label>
              <div class="mt-1 sm:col-span-2 sm:mt-0">
                <div class="flex max-w-lg justify-center rounded-md border-2 border-dashed border-gray-300 px-6 pt-5 pb-6">
                  <div class="space-y-1 text-center">
                    ...
                    <div class="flex text-sm text-gray-600">
                      <label for="file-upload" class="relative cursor-pointer rounded-md bg-white text-indigo-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-500 focus-within:ring-offset-2 hover:text-indigo-500">

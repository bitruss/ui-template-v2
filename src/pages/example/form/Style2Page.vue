    ...
    <div class="mt-5 grid grid-cols-12">
      <div class="overflow-hidden rounded-lg bg-white shadow col-span-12 xl:col-span-8">
        <div class="px-4 py-5 sm:p-6">
          <div>
            <h3 class="flex text-lg font-medium leading-6 text-gray-900">Personal Information</h3>
            <p class="mt-1 text-sm text-gray-500">Use a permanent address where you can receive mail.</p>
          </div>

          <form action="#" method="POST">
            <div class="bg-white px-4 py-5 sm:p-6 sm:border-t sm:border-gray-200 mt-5">
              <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-4">
                  <label for="email-address" class="flex text-sm font-medium text-gray-700">Email address</label>
